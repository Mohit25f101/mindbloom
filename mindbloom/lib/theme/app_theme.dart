...
/// Implements Therapeutic Minimalism design with Mindful Serenity color palette.
class AppTheme {
  AppTheme._();
  ...
  static const Color secondaryLight = Color(0xFF7B68EE); // Supportive purple
  static const Color successLight = Color(0xFF50C878); // Gentle emerald
  static const Color warningLight = Color(0xFFFFB347); // Soft amber
  static const Color errorLight = Color(0xFFFF6B6B); // Compassionate coral
  static const Color backgroundLight = Color(0xFFFAFBFC); // Warm off-white
  static const Color surfaceLight = Color(0xFFFFFFFF); // Pure white
  static const Color outlineLight = Color(0xFFE1E5E9); // Subtle gray
  static const Color textPrimaryLight = Color(0xFF1A1D21); // Rich charcoal
  static const Color textSecondaryLight = Color(0xFF6B7280); // Balanced gray

  // Dark theme adaptations maintaining therapeutic principles
  static const Color primaryDark =
      Color(0xFF6BA3F0); // Lighter trustworthy blue
  static const Color secondaryDark =
      Color(0xFF9B86F5); // Lighter supportive purple
  static const Color successDark = Color(0xFF6BD085); // Lighter gentle emerald
  static const Color warningDark = Color(0xFFFFC266); // Lighter soft amber
  static const Color errorDark =
      Color(0xFFFF8A8A); // Lighter compassionate coral
  static const Color backgroundDark =
      Color(0xFF0F1419); // Deep therapeutic dark
  static const Color surfaceDark = Color(0xFF1A1F26); // Elevated surface dark
  static const Color outlineDark = Color(0xFF2D3748); // Subtle dark outline
  static const Color textPrimaryDark = Color(0xFFF7FAFC); // Soft white
  static const Color textSecondaryDark = Color(0xFFA0AEC0); // Muted light gray
  ...
  // Shadow colors with therapeutic restraint (max 0.12 opacity)
  static const Color shadowLight = Color(0x1F000000); // 0.12 opacity
  static const Color shadowDark = Color(0x1F000000); // 0.12 opacity

  // Divider colors for minimal visual separation
  static const Color dividerLight = Color(0xFFE1E5E9);
  static const Color dividerDark = Color(0xFF2D3748);

  /// Light theme implementing Therapeutic Minimalism
  static ThemeData lightTheme = ThemeData(
    ...
    // AppBar theme for therapeutic trust-building
    appBarTheme: AppBarTheme(
      backgroundColor: surfaceLight,
      foregroundColor: textPrimaryLight,
      elevation: 0, // Minimal elevation for calm aesthetic
    ...
    bottomNavigationBarTheme: BottomNavigationBarThemeData(
      ...
      elevation: 8.0, // Maximum therapeutic elevation
    ...
    // Floating action button for crisis support accessibility
    ...
    // Button themes maintaining therapeutic approachability
    ...
    // Typography implementing Inter for headings and body text
    textTheme: _buildTextTheme(isLight: true),

    // Input decoration optimized for vulnerable moments
    ...
    // Interactive elements with therapeutic color responses
  ...
  static TextTheme _buildTextTheme({required bool isLight}) {
    ...
    return TextTheme(
      ...
      // Label styles - Roboto for captions and UI elements
